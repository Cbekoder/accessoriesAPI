...
class InputListItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        with transaction.atomic():
            ...
            self.product.save()
            self.input_list.total = self.input_list.importlistitem_set.aggregate(Sum('total_sum'))['total_sum'] or 0.0
...
class SaleItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.total_sum = self.amount * self.product.price
        super().save(*args, **kwargs)

        self.sales_list.total_sum = self.sales_list.saleitem_set.aggregate(Sum('total_sum'))['total_sum'] or 0.0
